...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private class LucidSettingsObserver extends ContentObserver {
        LucidSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private LucidSettingsObserver mLucidSettingsObserver;
    ...
    public VolumeDialogImpl(Context context) {
        ...
        mLucidSettingsObserver = new LucidSettingsObserver(mHandler);
        mLucidSettingsObserver.observe();
        mLucidSettingsObserver.update();
    }
